...
def setup_data():
    ...
    ethylene_path = os.path.join(script_dir, 'new_ethylene_c')
    ...
    ref_pitch = 1.11298E-02 
    ref_asymm = 5.54525E-01
    ref_sigma = 3.55743E+00
    ref_theta = 1.10850E-03
...
def test_conical_characterization(setup_data):
    ...
    assert abs(j.p[0] - 8.14099E+00) < 0.01, f'Conical calculated characterization (a) p[0] differs: {j.p[0]}'
    assert abs(j.b[0] - 2.53734E+00) < 0.05, f'Conical calculated characterization (a) b[0] differs: {j.b[0]}'
