...
def setup_data():
    ...
    ethylene_path = os.path.join(script_dir, 'new_ethylene_b')
    ...
    ref_pitch = 1.02613E-01
    ref_asymm = 4.88553E-01
    ref_sigma = 5.68158E-01
    ref_theta = 2.97293E-01
...
def test_conical_characterization(setup_data):
    ...
    assert abs(j.p[0] - 2.52408E-01) < 0.01, f'Conical calculated characterization (a) p[0] differs: {j.p[0]}'
    assert abs(j.b[0] - 1.01774E+00) < 0.01, f'Conical calculated characterization (a) b[0] differs: {j.b[0]}'
